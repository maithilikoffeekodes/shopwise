...
<div class="row">
    <div class="col-lg-12">
        <form action="<?= url('admin/Home/createcategory') ?>" class="ajax-form-submit" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="form-label">category: <span class="tx-danger">*</span></label>
                <input class="form-control" name="category" placeholder="Enter Name" required type="text" value="<?= @$category['category']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="file" class="dropify" data-height="200" name="image" data-height="100" data-allowed-file-extensions="png jpg jpeg jfif" data-default-file="<?= (!empty(@$category)) ? @$category['image'] : '' ?>">
            </div>
