...
<div class="page-header">
    <div>
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Banner Detail</a></li>
            <li class="breadcrumb-item active" aria-current="page">Banner Details</li>
        </ol>
    </div>
    <div class="btn btn-list">
            <a data-toggle="modal" href="<?= url('admin/Home/createbanner')?>" data-target="#fm_model"
                    data-title="Add Banner" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-round" style="float: right;"><span class="mdi mdi-plus"></span> Add Banner</a>
    </div>
</div>
<!-- End Page Header -->
<div class="row">
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="banner" data-module="admin/Home" data-filter_data='' style="width:100%">
