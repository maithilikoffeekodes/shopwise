...
<div class="row">
    <div class="col-lg-12">
        ...
        ?>
        <form action="<?= url('admin/Home/createbanner') ?>" class="ajax-form-submit" method="post" enctype="multipart/form-data">

            <div class="form-group">
                <label class="form-label">banner: <span class="tx-danger">*</span></label>
                <input class="form-control" name="banner" placeholder="Enter Name" required type="text" value="<?= @$banner['banner']; ?>">
                <input value="<?= @$banner['id'] ?>" name="id" type="hidden">
            </div>

            <div class="form-group">
                <label class="form-label">Image : <span class="tx-danger">*</span></label>
                <input type="file" class="dropify" data-height="200" name="image" data-height="100" data-default-file="<?= (!empty(@$banner)) ? @$banner['image'] : '' ?>">
            </div>

            <div class="form-group">
                <label class="form-label">Link: <span class="tx-danger">*</span></label>
                <input class="form-control" name="link" value="<?= @$banner['link']; ?>" placeholder="Enter Link" type="text" required>
