...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Contact</h2>
    </div>
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="contact" data-module="admin/Home" data-filter_data='' style="width:100%">
